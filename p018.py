# Problem 18
# Finding the greatest sum down a triangle
test = [[0 for x in range(y+1)] for y in range(5)]
test[0] = [3]
test[1] = [7,4]
test[2] = [2,4,6]
test[3] = [8,5,9,3]

tri = [[0 for x in range(y+1)] for y in range(15)]
...
#Recursion
def find_sum(x,y):
    return tri[y][x] + (0 if y==14 else max(find_sum(x,y+1),find_sum(x+1,y+1)))
