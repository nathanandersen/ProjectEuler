...
# Problem 11
# Finding the greatest product of four adjacent numbers
# in the same direction

grid = [[0 for x in range(20)] for x in range(20)]

grid[0] = [8,2,22,97,38,15,00,40,00,75,4,5,7,78,52,12,50,77,91,8]
grid[1] = [49,49,99,40,17,81,18,57,60,87,17,40,98,43,69,48,4,56,62,00]
...
grid[11] =[16,39,5,42,96,35,31,47,55,58,88,24,00,17,54,24,36,29,85,57]
grid[12] =[86,56,00,48,35,71,89,7,5,44,44,37,44,60,21,58,51,54,17,58]
